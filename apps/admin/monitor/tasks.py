...
from apps.admin.utils.decorators import BaseCeleryApp
...
@BaseCeleryApp(name='apps.admin.monitor.tasks.get_monitor_info', save_success_logs=False)
...
@BaseCeleryApp(name='apps.admin.monitor.tasks.clean_surplus_monitor_info')
