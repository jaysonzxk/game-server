# Generated by Django 2.2.16 on 2023-11-20 09:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('income', models.DecimalField(blank=True, decimal_places=6, max_digits=15, null=True, verbose_name='抽点金额')),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PayOrders_order', to=settings.AUTH_USER_MODEL, verbose_name='关联用户')),
            ],
            options={
                'verbose_name': '收益排行',
                'verbose_name_plural': '收益排行',
            },
        ),
    ]
