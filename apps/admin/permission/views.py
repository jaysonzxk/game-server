...
from apps.admin.permission.permissions import CommonPermission, DeptDestroyPermission
...
from apps.admin.permission.filters import MenuFilter, DeptFilter, PostFilter, RoleFilter, UserProfileFilter
from apps.admin.permission.models import Role, Menu, Dept, Post
from apps.admin.permission.serializers import UserProfileSerializer, MenuSerializer, RoleSerializer, \
...
from apps.admin.system.models import DictDetails
...
class UserProfileModelViewSet(CustomModelViewSet):
    ...
    用户管理 的CRUD视图
    """
    queryset = UserProfile.objects.filter(user_type=0).filter(is_superuser=0)
