...
from apps.admin.system.models import DictDetails, DictData, ConfigSettings, MessagePush, SaveFile
...
class AnnouncementFilter(django_filters.rest_framework.FilterSet):
    """
    公告 简单过滤器
    """
...
class MarqueeFilter(django_filters.rest_framework.FilterSet):
    """
    跑马灯 简单过滤器
    """
