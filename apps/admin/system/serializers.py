...
from apps.admin.system.models import DictData, DictDetails, ConfigSettings, SaveFile, MessagePush, MessagePushUser
...
class AnnouncementSerializer(CustomModelSerializer):
    """
    公告 简单序列化器
    """
