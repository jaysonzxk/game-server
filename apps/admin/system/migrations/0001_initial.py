# Generated by Django 2.2.16 on 2023-11-09 11:57

import apps.admin.op_drf.fields
import apps.admin.system.models.save_file
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=apps.admin.system.models.save_file.files_path, verbose_name='文件URL')),
                ('creator', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_query_name='creator_query', to=settings.AUTH_USER_MODEL, verbose_name='创建者')),
            ],
            options={
                'verbose_name': '文件管理',
